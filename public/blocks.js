...
export const BLOCK_TYPES = {
  yellow: { color:"#f1c40f", size:40, hp: 70, dmg: 6, slow: 0.30, xp: 9990, levelMin:1,  levelMax:10 },
  blue:   { color:"#3498db", size:50, hp:110, dmg: 9, slow: 0.40, xp: 9990, levelMin:10, levelMax:30 },
